        ...
        <div class="ev-tables-row">
            ...
            <div class="ev-panel" id="ev-panel-alumnos">
                ...
                <div class="ev-nav-bar">
                    <button class="ev-nav-btn" id="ev-alumnos-prev" title="Anterior">
                        <span class="ev-nav-arrow">&#9664;</span> Anterior
                    </button>
                    <button class="ev-nav-btn ev-nav-right" id="ev-alumnos-next" title="Siguiente">
            ...
            <div class="ev-panel" id="ev-panel-reactivos">
                ...
                <div class="ev-nav-bar">
                    <button class="ev-nav-btn" id="ev-reactivos-prev" title="Anterior">
                        <span class="ev-nav-arrow">&#9664;</span> Anterior
                    </button>
                    <button class="ev-nav-btn ev-nav-right" id="ev-reactivos-next" title="Siguiente">
                        Siguiente <span class="ev-nav-arrow">&#9654;</span>
                    </button>
                </div>
