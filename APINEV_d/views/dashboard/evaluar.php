...
//   1. Se añade botón "📄 Generar PDF" debajo de la tabla de alumnos
//   2. El JS (evaluar.js) lo activa cuando hay alumno + instrumento seleccionados
    ...
    <section class="content-area ev-content">
        ...
        <div class="ev-tables-row">
            ...
            <div class="ev-panel" id="ev-panel-alumnos">
                ...
                <!-- ★ BOTÓN PDF — aparece deshabilitado hasta seleccionar alumno ★ -->
