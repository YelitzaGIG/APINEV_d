...
// Invocada por AuthController::login()
...
// Si se llega directamente (GET sin pasar por el controlador),
// ejecutar el controlador
if ($_SERVER['REQUEST_METHOD'] === 'POST' || !isset($error)) {
    require_once __DIR__ . '/../../config/conexion.php';
    require_once __DIR__ . '/../../controllers/AuthController.php';
    $ctrl = new AuthController($pdo);
    $ctrl->login(); // Incluye esta misma vista al final
    exit;
}
...
<main class="form-wrapper">
  <div class="form-card">
    ...
    <form method="POST" action="/views/auth/login.php" novalidate>
